...
class MQTTClient:
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        try: 
            ...
            self.client.subscribe("application/f4994b60-cc34-4cb5-b77c-dc9a5f9de541/device/647fda0000008577/event/up")
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            elif topic.endswith("647fda0000008577/event/up"):
    ...
    def run_periodic_predictions(self):
            ...
            while self.thread_alive:
                ...
                if self.data_points:
                    ...
                    logging.info("run_periodic_predictions: In den letzten 30 Minuten wurden keine Daten gesammelt.")
